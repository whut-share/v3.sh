...
sed -i "/ExecStart=\/opt\/ServerStatus\/stat_client/c\ExecStart=\/opt\/ServerStatus\/stat_client -a \"http://45.159.48.59:8888/report\" -g g2 -p pp --alias ${ip} --disable-ping" stat_client.service
